...
const AboutDetails = () => {
  ...
  return (
    ...
    className="w-full mt-16 sm:mt-24  px-5 sm:px-10 md:px-24 sxl:px-32 ">
      ...
      initial="hidden"
      animate="visible"
      class="bg-accentSoft dark:bg-accentDark text-white dark:text-accent text-center py-8">
            <h1 class="text-4xl font-bold">TECHTALKS</h1>
            <p class="mt-2">Your Gateway to Tomorrow's Technology</p>
        </motion.header>
